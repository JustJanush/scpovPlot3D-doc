...
//=============================
#declare VVV  = CreateVLJ(H2O_Atoms) //PTube)
#declare VVV3 = CreateVLJ2(H2O_Atoms) //PTube)
...
//#declare ISOx = union{
    ...
    #declare ISO6 = MakeEquiPlane( VVV, -1.5/25, BoxMin, BoxMax )
    object{ISO6}
