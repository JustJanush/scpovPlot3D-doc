...
#local StrmLineTable[7][0][0] = Npts;
#local _VV = VectorCF(_P0, 1); // local electric vector [V/m]
#local StrmLineTable[7][1][0] = rr; //rrr*vlength(VV); // vector length [V/m]=>radius of given node of streamline
#local StrmLineTable[7][1][1] = _P0.x; // [A]
#local StrmLineTable[7][1][2] = _P0.y; // [A]
#local StrmLineTable[7][1][3] = _P0.z; // [A]
...
#for(ind, 2, Npts) // Runge-Kutta of 4 order           
    ...
    #local StrmLineTable[7][ind][0] = rr; //rrr*vlength(VV); // vector length [V/m]=>radius of given node of streamline
    #local StrmLineTable[7][ind][1] = _P1.x; // [A]
    #local StrmLineTable[7][ind][2] = _P1.y; // [A]
    #local StrmLineTable[7][ind][3] = _P1.z; // [A]
    #local _P0 = _P1;
    #local _VV = VectorCF( _P0, 1); // local electric vector [V/m]
...
// lets make streamlines
#local StrmLineTable[8][0][0] = Npts;
#local _VV = VectorCF(_P0, 1); // local electric vector [V/m]
#local StrmLineTable[8][1][0] = rr; //rrr*vlength(VV); // vector length [V/m]=>radius of given node of streamline
#local StrmLineTable[8][1][1] = _P0.x; // [A]
#local StrmLineTable[8][1][2] = _P0.y; // [A]
#local StrmLineTable[8][1][3] = _P0.z; // [A]
...
#for(ind, 2, Npts) // Runge-Kutta of 4 order           
    ...
    #local StrmLineTable[8][ind][0] = rr; //rrr*vlength(VV); // vector length [V/m]=>radius of given node of streamline
    #local StrmLineTable[8][ind][1] = _P1.x; // [A]
    #local StrmLineTable[8][ind][2] = _P1.y; // [A]
    #local StrmLineTable[8][ind][3] = _P1.z; // [A]
    #local _P0 = _P1;
    #local _VV = VectorCF( _P0, 1); // local electric vector [V/m]

#end            

#local alpha0 = 104.45; // degrees
#local alpha0 = radians(alpha0); // radians
#declare _P0 = radii*<cos(alpha0),        yy,  -sin(alpha0)>;  // test: cylinder{P00,VV,StrmLineTable[1][0]*1000 texture{pigment{color rgb<1.0, .3,  .3>} finish{phong .7 reflection metallic}}}
