...
cylinder{ <.0, 0.0001, .0>, 
    ...
    rotate 90*x
    rotate (90-alf_)*y
    translate 1.85*<cos(alfr),0,-sin(alfr)>    // left|right
    translate .7*<sin(alfr), 0,cos(alfr)>    // top|bottom
//    translate 4*x
}

SetCameraTarget(.0, 1.1, -.7)           
