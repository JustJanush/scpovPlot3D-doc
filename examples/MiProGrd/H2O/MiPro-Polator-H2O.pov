...
//#declare Molecule = object{CreateStruct( Graphene_Atoms, Graphene_Bonds, 0.2)}; // PTube, Bonds, .05)};
 #declare Molecule = object{CreateStruct( H2O_Atoms, H2O_Bonds, 0.1)}; // *** PTube, Bonds, .05)};7
object{Molecule} 

//====[ Control box ]==========
#declare dy = 0.05;  // *** BoxMax modifier, [0.0..>1] designates upper cross section plane position: 0=XY plane, 1=no change >1 increase BoxMax
...
////===================
    #case ( _IsoSurf )
        ...
        #declare BoxMin = _MoleculeCenter+ 2.95*(BoxMin-_MoleculeCenter);   
        #declare BoxMax = _MoleculeCenter+ 2.95*(BoxMax-_MoleculeCenter);
...
// SetIsoTexture( texture{ pigment{color rgbt<.5,0.5,0.5,.0>}} )
      ...
      SetIsoTexture( texture{ pigment{color rgbt<1,0.1,0,.0>}} )
       #declare ISO4 = MakeEquiPlane( VVV, 100.01, BoxMin, BoxMax )   // ***
       object{ISO4}

      SetIsoTexture( texture{ pigment{color rgbt<1,0.1,.5, .0>}} )
       #declare ISO5 = MakeEquiPlane( VVV, 2, BoxMin, BoxMax )
       //object{ISO5}
